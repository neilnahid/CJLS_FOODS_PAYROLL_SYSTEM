...
{
    public partial class Attendance : IDataErrorInfo
    {
        ...
        public Visibility ValidatioNErrorFlag { get; set; }
            ...
            get {
                ...
                switch (name)
                {
                    case "RegularHoursWorked":
                        if (PayrollDetail != null && PayrollDetailsID != 0)
                        {
                            if (RegularHoursWorked > PayrollDetail.Employee.DailyRequiredHours)
                                result = $"Regular hours must not exceed {PayrollDetail.Employee.DailyRequiredHours}.";
                        }
                        break;
                }
